...
public class InventoryManagementScreen extends JFrame {
    ...
    public InventoryManagementScreen() {
        ...
        setVisible(true);
        String dbPath = new File("ex1_solution_2025_ArchiTechs.accdb").getAbsolutePath();
        control.loadDataFromAccessDB(dbPath);

        System.out.println("Connecting to Access DB at: " + dbPath);
